module.exports = {
    ...
    entities: {
        ...
        cars: {
            v00: {id:'v00', position: null}, // {'x': -50, 'y': 50, 'z': 0}} //, speed:0, parcel:null, state:VehicleState.IDLE}
        },
        buses: {
        ...
        parcels: {
            p00: {id:'p00', carrier: {type: 'hub', id: 'h00'}, destination: {type: 'hub', id: 'h01'}, createMission: true}
        },
        missions: {
