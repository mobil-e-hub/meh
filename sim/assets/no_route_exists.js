module.exports = {
    _description: "Scenario with parcel at additional hub that has no connection to graph --> vue should show error message",
    topology: {
        nodes: {
            ...
            n11: {id: 'n11', position: {x: 70, y: 0, z: 0}, type: 'air'}
        },
        edges: {
