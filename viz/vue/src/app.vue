...
export default {
    ...
    created: function() {
        ...
        this.$mqtt.subscribe('car/+/arrived', (topic, message) => this.showToastStatus('Car arrived', `Car ${topic.id} has arrived at node ${message}.`));
        ...
        this.$mqtt.subscribe('parcel/+/delivered', (topic, message) => this.$store.commit('parcelDelivered', topic.id));
